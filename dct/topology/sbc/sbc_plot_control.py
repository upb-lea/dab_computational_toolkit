...
import hct
import femmt as fmt
import dct.topology.sbc.sbc_generalplotsettings as gps
from dct.topology.sbc.sbc_circuit_topology import SbcCircuitOptimization
...
class ParetoPlots:
    ...
    def plot_circuit_results(toml_prog_flow: dct.FlowControl, is_pre_summary: bool = False) -> None:
        ...
        sbc_config = dct.SbcCircuitOptimization.load_stored_config(
        ...
        df_circuit = dct.SbcCircuitOptimization.study_to_df(sbc_config)
    ...
    def plot_summary(toml_prog_flow: dct.FlowControl, is_pre_summary: bool = False) -> None:
        ...
        df_filtered = dct.SbcCircuitOptimization.filter_df(df, x="total_volume", y="total_mean_loss",
