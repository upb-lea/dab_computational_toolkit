...
import dct.design_check.sim_gecko as sim_gecko
import dct.design_check.plot_dab as plot_dab


def dab_sim_save_zvs(design_specification: str, transistor_1: tdb.Transistor, transistor_2: tdb.Transistor):
...
def plot_mod_sim(dab, name, comment, directory, mod_keys, show_plot=True, logfile=str()):
    ...
    for m in mod_keys:
        ...
        plt.subplot_contourf(dab.mesh_P[:, v1_middle, :],
                             dab.mesh_V2[:, v1_middle, :],
                             dab['sim_' + m + '_p_cond1'][:, v1_middle, :] + dab['sim_' + m + '_p_cond2'][:, v1_middle, :],
                             mask1=mask1,
                             mask2=mask2,
                             mask3=mask3,
...
if __name__ == '__main__':
    ...
    dab_sim_save_zvs(design_specification, transistor_1, transistor_2)
